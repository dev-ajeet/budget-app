 ...
 * A technique for adding big chunks of HTML into DOM;
 * How to replace parts of string
 * How to do DOM manipulation using the insertAdjacentHTML method. 
 * Difference between single quotes and double quotes: Even a string begins with a single quotes then it should end with the single quotes and same for double quotes, then it should only be consider end of string. 
 * 
 * 
 */
