/********************
 * Getting the current data by using the Date object constructor. 
 * How and when to use change events. 
 * Improving the UX design.Here we will use the change event. We will addd the event listener to the +/- button and wait for the event to happen. 
 * 
 *
 */
...
var uiController = (function() {
  ...
  return {
    ...
    displayMonth: function(){
          ...
          var now = new Date(); //this function constructor will give todays date. So 'now' will be the object of todays date: Sat Oct 05 2019 19:53:29 GMT+0530 (India Standard Time)
      //     var christmas = new Date(2016, 11, 25)
            year = now.getFullYear(); 
            month = now.getMonth();
            //this array is zero base
    ...
    changeType: function(){
          var fields = document.querySelectorAll(
            ...
            nodeListForEach(fields, function(cur){ //index number we don't need
